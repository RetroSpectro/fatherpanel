...
import {PasswordHasherBindings, RefreshTokenConstants, RefreshTokenServiceBindings, TokenServiceBindings, TokenServiceConstants, UserServiceBindings} from './keys';
import {BcryptHasher, JWTService, MyUserService,JwtRefreshService} from './services';
...
export class UserAppService extends BootMixin(
  ...
  private setUpBindings(): void {
    ...
    this.bind(RefreshTokenServiceBindings.REFRESH_TOKEN_SERVICE).toClass(JwtRefreshService);
